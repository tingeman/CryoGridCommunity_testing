...
b = get(gca);
b.junk = 'test';
[match, er1, er2] = comp_struct.comp_struct(a,b,1);
match
er1
comp_struct.list_struct(er1)
er2
comp_struct.list_struct(er2)
...
[match, er1, er2] = comp_struct.comp_struct(a,b,1,0,1e-3);
...
[match, er1, er2] = comp_struct.comp_struct(a,b);
match
comp_struct.list_struct(match)
er1
comp_struct.list_struct(er1)
er2
comp_struct.list_struct(er2)
...
[match, er1, er2] = comp_struct.comp_struct(stu1,stu2);
match
er1
comp_struct.list_struct(er1)
er2

function result = read_display_out(out, varargin)
    ...
    if nargin == 2
        plot_variables = varargin{1};
    else
        plot_variables = variableList;
    end
    ...
    for i=1:numberOfVariables
        if any(strcmp(plot_variables,variableList{i,1}))
            disp(['Plotting parameter: ' variableList{i,1}])
            figure
